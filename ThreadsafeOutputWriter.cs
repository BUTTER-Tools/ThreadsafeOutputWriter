...
namespace TSOutputWriter
{
    ...
    public class ThreadsafeOutputWriter : IDisposable
    {
        ...
        public ThreadsafeOutputWriter(string logPath, Encoding encoding, FileMode fileMode)
        {
            file = new FileStream(logPath, fileMode, FileAccess.Write, FileShare.Read);
